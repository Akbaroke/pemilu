...
const Input: React.FC<InputProps> = ({ label, id, value, errorLabel, disabled, isLoading, type = 'text', maxLength, onChange }) => {
  return (
    <div className="flex flex-col my-2 relative gap-1">
      ...
      <input
        ...
        maxLength={maxLength}
        className={`border border-[#EFF0F0] rounded-[10px] h-[37px] pl-3 text-[14px] font-medium text-one outline-none ${disabled ? 'bg-[#F4F5F7]' : ''}`}
      />
